...
WORKLOADS=(w0)
ITERATIONS=(50000)
#RATES=(5000 7000 9000 11000 13000 15000 17000 19000 21000 23000 25000 27000 29000 31000 33000 35000 37000 39000 41000 43000 45000 47000 49000 51000 53000 55000 57000)
RATES=(1000 3000)
        ...
        for d in ${ITERATIONS[@]}; do
            ...
            for r in ${RATES[@]}; do
                ...
                for j in `seq 0 $RUNS`; do
                    ...
                    # Run the server
                    SRV_ARGS="${SRV_HTs} ${SRV_APPLICATION} ${SRV_DISTRIBUTION} ${SRV_ITERATIONS}"
